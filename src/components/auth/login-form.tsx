...
import { signIn, signInWithGoogle, signInWithGithub } from '@/actions/auth'
  ...
  return (
    <Card className="w-full max-w-sm">
      <CardHeader>
        ...
        <CardDescription>Đăng nhập để học tiếng Nhật</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase"><span className="bg-paper px-2 text-mid-gray">Hoặc</span></div>
        </div>
        <div className="space-y-2">
        ...
        <p className="mt-4 text-center text-sm text-mid-gray">
          Chưa có tài khoản? <a href="/auth/register" className="text-ink underline underline-offset-4">Đăng ký</a>
        </p>
      </CardContent>
    </Card>
  )
