  ...
  if (isComplete) {
    ...
    return (
      <div className="mx-auto max-w-lg space-y-6 text-center">
        <h2 className="text-heading-sm font-semibold text-charcoal">Luyện chính tả hoàn thành!</h2>
        <Card>
          <CardContent className="p-4">
            <div className="text-5xl font-bold text-charcoal">{correct}/{attempts}</div>
    ...
    <div className="mx-auto max-w-lg space-y-6">
      ...
      <Card>
        <CardContent className="p-4 text-center">
          <p className="mb-4 text-xs text-fog">Nghe phát âm và gõ lại từ tiếng Nhật</p>
          ...
          <div className="mt-4 flex items-center justify-center gap-1">
            ...
            <span className="text-xs text-fog">{rate.toFixed(1)}x</span>
          ...
          {feedback === null ? (
            ...
            <div className="mt-6 space-y-4">
              <div className={`rounded-cards border border-ash p-4 ${feedback === 'correct' ? 'border-green-300 bg-green-50' : 'border-ember/30 bg-red-50'}`}>
